  ...
  return (
    <section id="about">
      ...
      <div className="about-box">
        ...
        <p>
          My journey involves transforming complex datasets into meaningful visualizations, 
          building responsive web applications, and leveraging modern technologies 
          to solve real-world problems. I believe in continuous learning and staying 
